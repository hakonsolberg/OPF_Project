...
def OPF_model(Data):
    ...
    ***** General constraints *****
    ...
    def  Min_gen_P(model,n):                                                                                                  #Generators providing more than min power
        return(model.gen_P[n] >= model.P_min)
